package com.github.ixtf.jl.service.api;
...
import static com.github.ixtf.jl.service.api.ApiModule.injectMembers;
...
public class ApiVerticle extends AbstractVerticle {
    ...
    public void start(Promise<Void> startPromise) throws Exception {
        ...
        router.route("/graphql/services/:service").handler(this::handleGraphql);
        router.route("/api/services/:service/actions/:action").handler(this::handleApi);
        ...
        vertx.createHttpServer(httpServerOptions).requestHandler(router).listen(29998).<Void>mapEmpty().onComplete(startPromise);
    }
