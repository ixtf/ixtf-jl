package com.github.ixtf.jl.service.report;

import com.github.ixtf.api.guice.MongoModule;
import com.github.ixtf.jl.service.report.guice.ReportServiceModule;
...
public class ReportServiceLauncher extends Launcher {
    public static void main(String[] args) {
        new ReportServiceLauncher().dispatch(args);
    }
    ...
    public void afterStartingVertx(Vertx vertx) {
        ...
        init(new ReportServiceModule(vertx, config), new MongoModule());
    }
